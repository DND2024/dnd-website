  ...
  return (
    <footer className="footer bg-[url(/clip.webp)] bg-cover dark:bg-[#161922] ">
      <div className="footer-logo">
        <img src="dnd-logo.webp" alt="DND Logo" className="dnd-logo" />
      </div>
      ...
      <div className="footer-contact dark:invert">
        ...
        <div className="footer-phone">
          ...
          <img
            src="contact_logo.webp"
            alt="Contact"
            className="icon phone-icon"
          />
          <p className="underline">+91 987654321 &nbsp; +91 987654321</p>
        </div>
      </div>
      ...
      <div className="footer-social dark:invert">
        ...
        <a
          href="https://www.instagram.com/dnd_nitc/"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/company/forum-for-dance-and-dramatics/?originalSubdomain=in"
          target="_blank"
          rel="noopener noreferrer"
        >
