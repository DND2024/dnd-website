...
export default function Meet( ) {
  ...
  return (
      ...
      <div className="relative z-0 dark:bg-[#191919] dark:text-white font-ubuntu flex flex-grow flex-col items-center justify-center gap-y-10 rounded-[20px] bg-neutral-300 px-11 pb-12 pt-56 leading-[normal] mb-8 tracking-[0px] mx-20">
       {currentPage > 0 && (
        ...
        <a onClick={handleMoreClick} className="cursor-pointer absolute bottom-3.5 right-3.5 flex h-[18px] w-[59px] flex-shrink-0 items-end justify-end text-right leading-[normal] text-blue-500 hover:underline">
          {"MORE>"}
        </a>
