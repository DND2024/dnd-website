  ...
  return (
    <section className="header">
      <nav className="bg-[#EFEEE0] w-screen text-black flex justify-between items-center px-4 ">
        ...
        <div className="nav-link montserrat-subrayada-bold hover:cursor-pointer  bg-[#EFEEE0] left-0  md:py-0 py-10 md:w-auto w-full mt-[100%] float-start md:mt-0 absolute md:static ">
